...
{{
  ...
  "fundamental_snapshot": {{
    ...
    "notes": "사실 기반 1~2줄 — 업종 평균 대비 어떤지 등. 평가어("좋다/나쁘다") 사용 금지"
  }},
  "technical_snapshot": {{
    "rsi": <숫자|null>, "ma_alignment": "<문자열>",
    "key_events": ["골든크로스", "60일 신고가 근접" 등 사실],
    "support_resistance": "지지 X / 저항 Y" 형식 문자열,
  ...
  "user_position": {"null (평단 입력 없으면)" if not avg_price_int else "(아래 context_notes 만 채워주세요. 손익은 코드에서 계산되어 들어갑니다.)"},
  "factors_to_consider": [
    "사용자가 판단에 활용할 수 있는 *사실*들 3~5개.",
    "예: '실적 발표 D-7, 변동성 급등 가능' / 'RSI 86 + 외인 매도 — 상반 신호'",
    "*권유 표현 금지*. *동사로 행동 지시 금지*."
  ]{f''',
  "user_position_notes": [
    "평단 입력 시 *손익은 코드에서 계산되어 들어갑니다*. 여기엔 사용자가 평단을 보고 *판단의 맥락이 될 사실*만 2~3개 적어주세요.",
    "예: '60일 최저 47,200원 대비 +2.0% 위치' / '20일 평균선 49,500원 아래'",
    "*매도/추매 권유 절대 금지*."
